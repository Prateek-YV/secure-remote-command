...
|--------|------|-----------------|------------|
| **YELLAPANTULA VENKATA PRATEEK** (SRN: PES2UG24CS617) | Server & Security Developer | Server architecture, SSL/TLS implementation, Multi-threading, Command execution engine, Security features | `server.py` |
| **NARENDRA J KATHARE** (SRN: PES2UG25CS814) | Client & Protocol Developer | Client implementation, Protocol design (JSON), Authentication mechanism, User interface, Command parsing | `client.py` |
...
### YELLAPANTULA VENKATA PRATEEK (PES2UG24CS617) - Server & Security Developer
...
### NARENDRA J KATHARE (PES2UG25CS814) - Client & Protocol Developer
...
### VENKATESH (PES2UG24CS580) - Testing & Documentation Lead
...
|---------|-------------|----------------|
| SSL/TLS Encryption | All network traffic encrypted | YELLAPANTULA VENKATA PRATEEK |
| HMAC Authentication | Challenge-response authentication | NARENDRA J KATHARE |
| Multi-client Support | Multiple concurrent clients with threading | YELLAPANTULA VENKATA PRATEEK |
| JSON Protocol | Structured message format | NARENDRA J KATHARE |
| Audit Logging | Complete log of all actions | VENKATESH |
| Command Injection Prevention | No shell=True, list arguments | YELLAPANTULA VENKATA PRATEEK |
| Performance Testing | Latency, throughput, scalability | VENKATESH |
| Cross-Platform | Works on Windows and Linux | NARENDRA J KATHARE |
...
- pyOpenSSL library
- Network connection (for multi-laptop setup)
