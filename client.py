...
--------------------------------------------------------------------------------
  ...
  type <filename>       - View contents of a file (like cat)
  echo <text> > file    - Create file with text (e.g., echo Hello > test.txt)
...
TEXT PROCESSING:
--------------------------------------------------------------------------------
  findstr <text> <file> - Search for text in files (like grep)
...
--------------------------------------------------------------------------------
  ...
  clear / cls           - Clear screen (client side)
...
NOTE: This is a Windows-based server. Linux commands like 'ls', 'cat', 'grep', 'ps'
      are mapped to Windows equivalents automatically.
...
def main():
    ...
    password = input("Password: ").strip()  # Not used in this demo
